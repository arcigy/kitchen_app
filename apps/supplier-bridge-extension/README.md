...
- The Side Panel uses the same required **username + password** identity contract as the Arcigy app. The server resolves the tenant from the unique active Arcigy user, and Bridge access is issued directly from that account.
