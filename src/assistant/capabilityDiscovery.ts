...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "editor-layout", title: "Layout editor", domains: ["editor", "wall", "floor", "column", "section", "opening", "measure", "align", "trim", "history"], keywords: ["presun", "move", "otoc", "rotate", "duplik", "delete", "zmaz", "undo", "redo", "zarovnaj", "align", "orez", "trim", "predlz", "extend", "stena", "wall", "podlaha", "floor", "stlp", "column", "rez", "section", "dvere", "door", "okno", "window", "mera", "measure", "vzdialenost", "distance"], toolIds: ["editor.moveSelection", "editor.rotateSelection", "editor.duplicateSelection", "editor.deleteSelection", "editor.alignLines", "editor.trimWallsToCorner", "history.undo", "history.redo", "wall.create", "opening.createDoor", "opening.createWindow", "opening.updateDoor", "opening.updateWindow", "opening.delete", "measure.createDistance", "floor.create", "column.create", "section.create"], description: "Shared layout mutations, semantic alignment and trim/extend, validated wall-hosted openings and associative distances through existing editor owners." },
  ...
  { id: "exports", title: "Exports", domains: ["export", "download", "render"], keywords: ["export", "stiah", "download", "json", "png", "pdf", "xlsx", "excel", "sheet", "kusovnik", "ponuk", "quotation", "snapshot", "scena", "scene", "render", "blender", "vizualiz"], toolIds: ["export.download", "render.blenderPreview", "export.marketingPdf", "export.pricingWorkbook"], description: "Confirmed deterministic project downloads, BOM-backed PDF/XLSX and Blender preview rendering with material review." },
  { id: "custom-furniture", title: "Custom furniture", domains: ["customFurniture", "wardrobe"], keywords: ["nabytok na mieru", "custom furniture", "pracovny stol", "reception", "pult", "wardrobe", "skrina", "doska", "board"], toolIds: ["customFurniture.create", "customFurniture.patchBoard", "wardrobe.create", "wardrobe.addPart"], description: "Confirmed custom-furniture boundary creation and board parameter editing, plus wardrobe creation and internal-board insertion." }
];
