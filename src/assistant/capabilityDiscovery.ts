...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "exports", title: "Exports", domains: ["export", "download", "render"], keywords: ["export", "stiah", "download", "json", "png", "pdf", "ponuk", "quotation", "snapshot", "scena", "scene", "render", "blender", "vizualiz"], toolIds: ["export.download", "render.blenderPreview", "export.marketingPdf"], description: "Confirmed deterministic project downloads, BOM-backed marketing PDF and Blender preview rendering with material review." },
