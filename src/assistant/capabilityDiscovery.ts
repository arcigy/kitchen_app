...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "custom-furniture", title: "Custom furniture", domains: ["customFurniture", "wardrobe"], keywords: ["nabytok na mieru", "custom furniture", "pracovny stol", "reception", "pult", "wardrobe", "skrina", "doska", "board"], toolIds: ["customFurniture.create", "customFurniture.patchBoard"], description: "Confirmed custom-furniture boundary creation and board parameter editing." }
];
