...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "editor-layout", title: "Layout editor", domains: ["editor", "wall", "floor", "column", "section", "history"], keywords: ["presun", "move", "otoc", "rotate", "duplik", "delete", "zmaz", "undo", "redo", "stena", "wall", "podlaha", "floor", "stlp", "column", "rez", "section"], toolIds: ["editor.moveSelection", "editor.rotateSelection", "editor.duplicateSelection", "editor.deleteSelection", "history.undo", "history.redo", "wall.create", "floor.create", "column.create", "section.create"], description: "Shared layout mutations through the existing editor and history owners." },
