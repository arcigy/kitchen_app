...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "exports", title: "Exports", domains: ["export", "download"], keywords: ["export", "stiah", "download", "json", "png", "snapshot", "scena", "scene"], toolIds: ["export.download"], description: "Confirmed deterministic project downloads." },
