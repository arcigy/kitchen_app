...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "exports", title: "Exports", domains: ["export", "download", "render"], keywords: ["export", "stiah", "download", "json", "png", "snapshot", "scena", "scene", "render", "blender", "vizualiz"], toolIds: ["export.download", "render.blenderPreview"], description: "Confirmed deterministic project downloads and Blender preview rendering with material review." },
