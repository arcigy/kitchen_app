...
export const ASSISTANT_CAPABILITY_PACKS: AssistantCapabilityPack[] = [
  ...
  { id: "editor-layout", title: "Layout editor", domains: ["editor", "wall", "floor", "column", "section", "opening", "measure", "history"], keywords: ["presun", "move", "otoc", "rotate", "duplik", "delete", "zmaz", "undo", "redo", "stena", "wall", "podlaha", "floor", "stlp", "column", "rez", "section", "dvere", "door", "okno", "window", "mera", "measure", "vzdialenost", "distance"], toolIds: ["editor.moveSelection", "editor.rotateSelection", "editor.duplicateSelection", "editor.deleteSelection", "history.undo", "history.redo", "wall.create", "opening.createDoor", "opening.createWindow", "opening.updateDoor", "opening.updateWindow", "opening.delete", "measure.createDistance", "floor.create", "column.create", "section.create"], description: "Shared layout mutations, validated wall-hosted openings and associative distances through existing editor owners." },
