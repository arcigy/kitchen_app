...
// node_modules/three-gpu-pathtracer/src/core/QuiltPathTracingRenderer.js
function* _task(cb) {
  const {
    viewCount,
    _camera,
...
var QuiltViewUtility = class {
  ...
  getCameraViewInfo(i, target = {}) {
    ...
    target.offsetDirection.set(1, 0, 0);
  ...
  setFromDisplayView(viewerDistance, displayWidth, displayHeight) {
    ...
    this.viewFoV = 2 * Math.atan(0.5 * displayHeight / viewerDistance);
  }
};
var QuiltPathTracingRenderer = class extends PathTracingRenderer {
  get samples() {
...
// node_modules/three-gpu-pathtracer/src/core/DynamicPathTracingSceneGenerator.js
...
var DynamicPathTracingSceneGenerator = class {
  get initialized() {
  ...
  prepScene() {
    ...
    for (let i = 0, l = objects.length; i < l; i++) {
      objects[i].traverse((c) => {
        ...
        } else if (c.isRectAreaLight || c.isSpotLight || c.isPointLight || c.isDirectionalLight) {
          lights.push(c);
        }
      });
    }
...
// node_modules/three-gpu-pathtracer/src/core/MaterialReducer.js
function isTypedArray(arr) {
  return arr.buffer instanceof ArrayBuffer && "BYTES_PER_ELEMENT" in arr;
}
var MaterialReducer = class {
  constructor() {
...
// node_modules/three-gpu-pathtracer/src/uniforms/utils.js
...
var MATTE_OFFSET = 14 * 4 + 0;
var SHADOW_OFFSET = 14 * 4 + 1;
...
var MaterialsTexture = class extends DataTexture {
  ...
  updateFrom(materials, textures) {
    ...
    function getUVTransformTexture(material) {
      return material.map || material.specularMap || material.displacementMap || material.normalMap || material.bumpMap || material.roughnessMap || material.metalnessMap || material.alphaMap || material.emissiveMap || material.clearcoatMap || material.clearcoatNormalMap || material.clearcoatRoughnessMap || material.iridescenceMap || material.iridescenceThicknessMap || material.specularIntensityMap || material.specularColorMap || material.transmissionMap || material.thicknessMap || material.sheenColorMap || material.sheenRoughnessMap || null;
    }
    ...
    for (let i = 0, l = materials.length; i < l; i++) {
      ...
      if (m.isFogVolumeMaterial) {
        ...
        floatArray[index + 2 * 4 + 3] = getField(m, "emissiveIntensity", 0);
      ...
      floatArray[index++] = getField(m, "metalness", 0);
      floatArray[index++] = getTexture(m, "metalnessMap");
      floatArray[index++] = getField(m, "roughness", 0);
      floatArray[index++] = getTexture(m, "roughnessMap");
      floatArray[index++] = getField(m, "ior", 1.5);
      floatArray[index++] = getField(m, "transmission", 0);
      floatArray[index++] = getTexture(m, "transmissionMap");
      floatArray[index++] = getField(m, "emissiveIntensity", 0);
      if ("emissive" in m) {
      ...
      floatArray[index++] = getField(m, "clearcoat", 0);
      floatArray[index++] = getTexture(m, "clearcoatMap");
      floatArray[index++] = getField(m, "clearcoatRoughness", 0);
      ...
      index++;
      floatArray[index++] = getField(m, "sheen", 0);
      if ("sheenColor" in m) {
      ...
      floatArray[index++] = getField(m, "sheenRoughness", 0);
      ...
      floatArray[index++] = getField(m, "iridescence", 0);
      ...
      floatArray[index++] = getField(m, "specularIntensity", 1);
      floatArray[index++] = getTexture(m, "specularIntensityMap");
      const isThinFilm = getField(m, "thickness", 0) === 0 && getField(m, "attenuationDistance", Infinity) === Infinity;
      ...
      if (!isThinFilm && m.transmission > 0) {
        floatArray[index++] = 0;
      } else {
        switch (m.side) {
          case FrontSide:
      ...
      index++;
      index++;
      floatArray[index++] = Number(m.vertexColors) | Number(m.flatShading) << 1;
...
var RenderTarget2DArray = class extends WebGLArrayRenderTarget {
  constructor(...args) {
    ...
    tex.setTextures = (...args2) => {
      this.setTextures(...args2);
    };
  ...
  updateFrom(lights, iesTextures = []) {
    ...
    for (let i = 0, l = lights.length; i < l; i++) {
      ...
      if (l2.isRectAreaLight) {
        ...
        floatArray[baseIndex + index++] = l2.iesTexture ? iesTextures.indexOf(l2.iesTexture) : -1;
      } else if (l2.isPointLight) {
...
// node_modules/three-gpu-pathtracer/src/utils/IESLoader.js
function IESLamp(text) {
  ...
  function readArray(count, array) {
    while (true) {
      const line2 = textArray[lineNumber++];
      const lineData = textToArray(line2);
  ...
  function readTilt() {
    let line2 = textArray[lineNumber++];
    let lineData = textToArray(line2);
    _self.tiltData.lampToLumGeometry = Number(lineData[0]);
    line2 = textArray[lineNumber++];
    lineData = textToArray(line2);
...
// node_modules/three-gpu-pathtracer/src/uniforms/IESProfilesTexture.js
var prevColor2 = new Color();
var IESProfilesTexture = class extends WebGLArrayRenderTarget {
  constructor(...args) {
    super(...args);
    const tex = this.texture;
    tex.format = RGBAFormat;
    ...
    tex.wrapT = ClampToEdgeWrapping;
    tex.generateMipmaps = false;
    tex.updateFrom = (...args2) => {
      this.updateFrom(...args2);
    };
  ...
  async updateFrom(renderer, textures) {
    ...
    const prevToneMapping = renderer.toneMapping;
    const prevAlpha = renderer.getClearAlpha();
    renderer.getClearColor(prevColor2);
    ...
    fsQuad.material.map = null;
    renderer.setClearColor(prevColor2, prevAlpha);
    renderer.setRenderTarget(prevRenderTarget);
    renderer.toneMapping = prevToneMapping;
    fsQuad.dispose();
  }
...
// node_modules/three-gpu-pathtracer/src/shader/common/utils.glsl.js
var utilsGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/fullscreen/GradientMapMaterial.js
var GradientMapMaterial = class extends MaterialBase {
  constructor(parameters) {
    super({
      defines: {
        FEATURE_BIN: 0
      ...
      uniforms: {
        ...
        minValue: { value: 0 },
        maxColor: { value: new Color(16777215) },
        maxValue: { value: 10 },
        field: { value: 0 },
        power: { value: 1 }
      },
...
// node_modules/three-gpu-pathtracer/src/materials/debug/GraphMaterial.js
var GraphMaterial = class extends MaterialBase {
  ...
  constructor(parameters) {
    super({
      ...
      uniforms: {
        ...
        thickness: { value: 1 },
        graphCount: { value: 4 },
        graphDisplay: { value: new Vector4(1, 1, 1, 1) },
        overlay: { value: true },
        xRange: { value: new Vector2(-2, 2) },
        yRange: { value: new Vector2(-2, 2) },
        colors: { value: [
          new Color(15277667).convertSRGBToLinear(),
          new Color(5025616).convertSRGBToLinear(),
          new Color(240116).convertSRGBToLinear(),
          new Color(16761095).convertSRGBToLinear()
        ] }
      },
      vertexShader: (
        /* glsl */
...
// node_modules/three-gpu-pathtracer/src/shader/structs/cameraStruct.glsl.js
var cameraStructGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/structs/equirectStruct.glsl.js
var equirectStructGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/structs/lightsStruct.glsl.js
var lightsStructGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/structs/materialStruct.glsl.js
var materialStructGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/structs/fogMaterialBvh.glsl.js
var fogMaterialBvhGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/bsdf/ggx.glsl.js
var ggxGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/bsdf/sheen.glsl.js
var sheenGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/bsdf/iridescence.glsl.js
var iridescenceGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/bsdf/bsdfSampling.glsl.js
var bsdfSamplingGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/bsdf/fog.glsl.js
var fogGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/sampling/equirectSampling.glsl.js
var equirectSamplingGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/sampling/lightSampling.glsl.js
var lightSamplingGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/sampling/shapeSampling.glsl.js
var shapeSamplingGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/common/intersectShapes.glsl.js
var intersectShapesGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/common/math.glsl.js
var mathGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/common/fresnel.glsl.js
var fresnelGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/shader/common/arraySamplerTexelFetch.glsl.js
var arraySamplerTexelFetchGLSL = (
  /*glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/renderStructs.glsl.js
var renderStructsGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/cameraUtils.glsl.js
var cameraUtilsGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/attenuateHit.glsl.js
var attenuateHitGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/traceScene.glsl.js
var traceSceneGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/getSurfaceRecord.glsl.js
var getSurfaceRecordGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/materials/pathtracing/glsl/directLightContribution.glsl.js
var directLightContributionGLSL = (
  /*glsl*/
  `
...
// node_modules/three-gpu-pathtracer/src/shader/rand/stratifiedTexture.glsl.js
var stratifiedTextureGLSL = (
  /* glsl */
  `
...
// node_modules/three-gpu-pathtracer/src/detectors/PrecisionMaterial.js
var computePrecisionFunction = (
  /* glsl */
  `
...
var PrecisionMaterial = class extends MaterialBase {
  set mode(v) {
    this._mode = v;
...
// node_modules/three-gpu-pathtracer/src/detectors/PrecisionDetector.js
var PrecisionDetector = class {
  constructor(renderer) {
    this._renderer = renderer;
    this._result = null;
  }
...
// node_modules/three-gpu-pathtracer/src/detectors/MaterialCompileDetector.js
var MaterialCompileDetector = class {
  constructor(renderer) {
    this._renderer = renderer;
  }
  detect(material) {
...
// node_modules/three-gpu-pathtracer/src/detectors/CompatibilityDetector.js
var CompatibilityDetector = class {
...
export {
  ...
  ShapedAreaLight,
  getDummyMesh,
  getGroupMaterialIndicesAttribute,
  setCommonAttributes
};
